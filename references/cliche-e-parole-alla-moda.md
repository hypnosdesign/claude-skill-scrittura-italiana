# Cliché, parole alla moda, frasi fatte, metafore morte
...
scrivere* (UTET, 2018); esempi originali. Complementa `stile-naturale.md` (i tic dell'AI) e
`retorica-efficacia.md` (i *tópoi* logori). `✓` = preferibile, `✗`/`⚠` = da evitare.
