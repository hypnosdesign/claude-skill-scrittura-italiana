# Revisione e proprietà della parola
...
> il testo nudo. (Collega `stile-naturale.md` §15, avverbi in *-mente*.)
...
> Sulle metafore *miste* (due immagini incompatibili nella stessa frase) vedi `stile-naturale.md`.
