# Narrativa — l'idea, il punto di vista, la licenza
...
infrante — ma come **licenza consapevole**, non per disattenzione (vedi `retorica-efficacia.md`
→ "Errore vs licenza").
...
- **Il dettaglio "carico"** (Carver): un oggetto comune reso con precisione può avere «un potere
  ...
  non se è inventario. (→ `stile-naturale.md` §42 *individuazione*; `revisione-e-proprieta.md` §3.)
...
- **Verbi e nomi forti** battono aggettivi e avverbi: non *camminava velocemente* ma *sfrecciava*
  (→ `revisione-e-proprieta.md` §3, test bidirezionale dell'aggettivo).
...
- **Ritmo:** frasi brevi accelerano e colpiscono; lunghe avvolgono. Alterna di proposito; leggi ad
  alta voce (→ `retorica-efficacia.md` §4).
...
della storia: a ogni passata capiva meglio cosa voleva dire (→ `revisione-e-proprieta.md` §5).
